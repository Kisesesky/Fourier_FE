...
│ │   │ │ │ ├─_models/                                │   │ │ │ ├─# type, schema, logic등
│ │   │ │ │ │ ├─constants/                            │   │ │ │ │ ├─# 상수 데이터
│ │   │ │ │ │ │ └─floating-dm.constants.ts            │   │ │ │ │ │ └─# 플로팅 디엠 상수 정의
│ │   │ │ │ │ ├─hooks/                                │   │ │ │ │ ├─# Hooks
│ │   │ │ │ │ │ └─useFloatingDmController.ts          │   │ │ │ │ │ └─# 플로팅 디엠 상수 정의
│ │   │ │ │ │ ├─utils/                                │   │ │ │ │ ├─# Utils
...
│ │   │ │ │ ├─_models/                                │   │ │ │ ├─# type, schema, logic등
│ │   │ │ │ │ └─types/                                │   │ │ │ │ └─# Types
│ │   │ │ │ │   └─home-page-modals.types.ts           │   │ │ │ │  └─# 홈페이지모달 타입
│ │   │ │ │ └─index.ts                                │   │ │ │ └─# components export
...
│ │   │ ├─_model/                                     │   │ ├─# type, schema, logic등
│ │   │ │ ├─constants/                                │   │ │ ├─# Constants
│ │   │ │ │ ├─friends.constants.ts                    │   │ │ │ ├─# 친구 상수 타입
│ │   │ │ │ ├─index.ts                                │   │ │ │ ├─# Index
│ │   │ │ │ ├─invite.constants.ts                     │   │ │ │ ├─# 홈페이지 모달 타입
│ │   │ │ │ ├─project.constants.ts                    │   │ │ │ ├─# 프로젝트 상수 정의
│ │   │ │ │ ├─view.constants.ts                       │   │ │ │ ├─# 뷰 상수 데이터
│ │   │ │ │ ├─workspace-settings.constants.ts         │   │ │ │ ├─# 워크스페이스 세팅 상수
│ │   │ │ │ ├─workspace-settings.types.ts             │   │ │ │ ├─# 워크스페이스 세팅 타입
│ │   │ │ │ └─workspace.constants.ts                  │   │ │ │ └─# 워크스페이스 상수/설정값
│ │   │ │ ├─hooks/                                    │   │ │ ├─# Hooks
│ │   │ │ │ ├─index.ts                                │   │ │ │ ├─# index
│ │   │ │ │ ├─useFriendsViewController.ts             │   │ │ │ ├─# 친구뷰 컨트롤러
│ │   │ │ │ ├─useLaftNavState.ts                      │   │ │ │ ├─# 왼쪽네비게이션 상태
│ │   │ │ │ ├─useSettingsPreferences.ts               │   │ │ │ ├─# 세팅
│ │   │ │ │ ├─useTeamMembersViewController.ts         │   │ │ │ ├─# 팀멤버 뷰 컨트롤러
│ │   │ │ │ ├─useTeams.ts                             │   │ │ │ ├─# 팀 목록/상태 
│ │   │ │ │ └─useWorkspaceSettingsModalController.ts  │   │ │ │ └─# 워크스페이스 세팅모달 컨트롤러
│ │   │ │ ├─schemas/                                  │   │ │ ├─# Schemas
│ │   │ │ │ ├─team-api.schemas.ts                     │   │ │ │ ├─# 팀 api Schema
│ │   │ │ │ └─team-members.schemas.ts                 │   │ │ │ └─# 팀 멤버 
│ │   │ │ ├─types/                                    │   │ │ ├─# Types
│ │   │ │ │ ├─home-page-modals.types.ts               │   │ │ │ ├─# 홈페이지 모달 타입
│ │   │ │ │ ├─index.ts                                │   │ │ │ ├─# index
│ │   │ │ │ ├─project.types.ts                        │   │ │ │ ├─# 프로젝트 타입 정의
│ │   │ │ │ ├─team-members.types.ts                   │   │ │ │ ├─# 팀 멤버 types
│ │   │ │ │ ├─view.types.ts                           │   │ │ │ ├─# 뷰 타입
│ │   │ │ │ └─workspace-settings.types.ts             │   │ │ │ └─# 워크스페이스 세팅
│ │   │ │ ├─utils/                                    │   │ │ ├─# Utils
│ │   │ │ │ └─view.utils.ts                           │   │ │ │ └─# 뷰 유틸
│ │   │ │ └─index.ts                                  │   │ │ └─# index
│ │   │ ├─_service/                                   │   │ ├─# API/서비스 등
│ │   │ │ ├─friends.api.ts                            │   │ │ ├─# 친구 api
│ │   │ │ ├─index.ts                                  │   │ │ ├─# components export
│ │   │ │ ├─team-members.api.ts                       │   │ │ ├─# 팀멤버 api
│ │   │ │ ├─teams.api.ts                              │   │ │ ├─# 팀 api
│ │   │ │ └─workspace-settings.api.ts                 │   │ │ └─# 워크스페이스 세팅 api
...
│ │   │ │ │ │ └─project-api.schemas.ts                │   │ │ │ │ └─# 프로젝트 api 스케마
│ │   │ │ │ ├─store/                                  │   │ │ │ ├─# Store
...
│ │   │ │ │ │ ├─call-room/                            │   │ │ │ │ ├─# 콜룸 컴포넌트
│ │   │ │ │ │ │ ├─_components/                        │   │ │ │ │ │ ├─# UI(해당 도메인/route 전용)
│ │   │ │ │ │ │ │ ├─CallControlsDock.tsx              │   │ │ │ │ │ │ ├─# 음성/화상 통화 컨트롤
│ │   │ │ │ │ │ │ ├─CallSidePanel.tsx                 │   │ │ │ │ │ │ ├─# 음성/화상 통화 사이드 판넬
│ │   │ │ │ │ │ │ ├─CallStage.tsx                     │   │ │ │ │ │ │ ├─# 음성/화상 통화 패널
│ │   │ │ │ │ │ │ └─useCallRoomConnection.ts          │   │ │ │ │ │ │ └─# 커넥션
...
│ │   │ │ │ │ │ │ └─event.constants.ts                │   │ │ │ │ │ │ └─# 이벤트 상수
│ │   │ │ │ │ │ ├─schemas/                            │   │ │ │ │ │ ├─# Schemas
│ │   │ │ │ │ │ │ └─channel-message.schema.ts         │   │ │ │ │ │ │ └─# 채널 메시지 Schemas
│ │   │ │ │ │ │ ├─actions.huddle.ts                   │   │ │ │ │ │ ├─# 액션 허들
│ │   │ │ │ │ │ ├─actions.realtime.ts                 │   │ │ │ │ │ ├─# 액션 리얼타임
│ │   │ │ │ │ │ ├─actions.thread-search.ts            │   │ │ │ │ │ ├─# 액션 스레드 서치
│ │   │ │ │ │ │ ├─actions.user.ts                     │   │ │ │ │ │ ├─# 액션 유저
│ │   │ │ │ │ │ ├─actions.workspace-channel.ts        │   │ │ │ │ │ ├─# 액션 워크스페이스 채널
│ │   │ │ │ │ │ ├─constants.ts                        │   │ │ │ │ │ ├─# 상수
│ │   │ │ │ │ │ ├─dm.ts                               │   │ │ │ │ │ ├─# 디엠
│ │   │ │ │ │ │ ├─messages.ts                         │   │ │ │ │ │ ├─# 메시지
│ │   │ │ │ │ │ └─types.ts                            │   │ │ │ │ │ └─# 타입
...
│ │   │ │ │ │ │ └─useThreadItems.ts                   │   │ │ │ │ │ └─# 스레드 아이템 
│ │   │ │ │ │ ├─schemas/                              │   │ │ │ │ ├─# Schemas
│ │   │ │ │ │ │ └─chat-api.schemas.ts                 │   │ │ │ │ │ └─# chat.api.schema
│ │   │ │ │ │ ├─shared/                               │   │ │ │ │ ├─# 공유
│ │   │ │ │ │ │ └─constants                           │   │ │ │ │ │ └─# 상수
│ │   │ │ │ │ │   └─storage.keys.ts                   │   │ │ │ │ │   └─# 키저장
│ │   │ │ │ │ ├─store/                                │   │ │ │ │ ├─# Store
...
│ │   │ │ │ │ ├─api.types.ts                          │   │ │ │ │ ├─# chat api types
│ │   │ │ │ │ ├─chatStore.ts                          │   │ │ │ │ ├─# chat Store
│ │   │ │ │ │ ├─emoji.shortcuts.ts                    │   │ │ │ │ ├─# 이모지
│ │   │ │ │ │ ├─index.ts                              │   │ │ │ │ ├─# components export
...
│ │   │ │ │ │ ├─schemas/                              │   │ │ │ │ ├─# Schemas
│ │   │ │ │ │ │ ├─docs-api.schemas.ts                 │   │ │ │ │ │ ├─# 문서 api 스케마
...
│ │   │ │ │ │ ├─schemas/                              │   │ │ │ │ ├─# Schemas
│ │   │ │ │ │ │ ├─file-api.schemas.ts                 │   │ │ │ │ │ ├─# 파일 api 스케마
│ │   │ │ │ │ │ └─file.schemas.ts                     │   │ │ │ │ │ └─# 파일 스케마
│ │   │ │ │ │ ├─store/                                │   │ │ │ │ ├─# Store
│ │   │ │ │ │ │ └─useFilePageStore.ts                 │   │ │ │ │ │ └─# 파일 페이지 Store
│ │   │ │ │ │ ├─api.types.ts                          │   │ │ │ │ ├─# 파일 api 타입 정의
...
│ │   │ │ │ │ ├─schemas/                              │   │ │ │ │ ├─# Schemas
│ │   │ │ │ │ │ └─issues-api.schemas.ts               │   │ │ │ │ │ └─# 이슈 API Schemas
│ │   │ │ │ │ ├─store/                                │   │ │ │ │ ├─# Store
...
│ │   │ │   │ ├─hooks/                                │   │ │   │ ├─# 이슈 hooks
│ │   │ │   │ │ ├─index.ts                            │   │ │   │ │ ├─# components export
│ │   │ │   │ │ └─useMembersViewController.ts         │   │ │   │ │ └─# 멤버 뷰 컨트롤러
│ │   │ │   │ ├─schemas/                              │   │ │   │ ├─# Schemas
...
│ ├─workspace.constants.ts                            ├─# 워크스페이스 상수
│ ├─workspace.schemas.ts                              ├─# 워크스페이스 스케마
│ ├─workspace.service.ts                              └─# 워크스페이스 서비스
│
...
│ ├─uploads.ts                                        ├─# 파일 업로드
│ ├─users.ts                                          ├─# 사용자 유틸
│ ├─utils.ts                                          ├─# tailwind-merge 및 clsx 같이 공용 유틸 
│ ├─workspace-entry.ts                                ├─# 워크스페이스 
