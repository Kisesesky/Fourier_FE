const TERMS_CONTENT = `
  ...
  <p className="mb-4">
    본 약관은 Fourier(이하 “회사”라 함)가 제공하는 우산 대여 서비스 및 관련 제반 서비스(이하 “서비스”라 함)의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
  </p>
  ...
  <ul className="list-disc list-inside mb-4 space-y-1">
    <li>“서비스”라 함은 구현되는 단말기(PC, 휴대형 단말기 등의 각종 유무선 장치를 포함)와 상관없이 회원이 이용할 수 있는 결제 등 회사가 제공하는 일체의 서비스를 의미합니다.</li>
