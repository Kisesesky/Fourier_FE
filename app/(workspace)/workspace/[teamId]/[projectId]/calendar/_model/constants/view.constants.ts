// Path: app/(workspace)/workspace/[teamId]/[projectId]/calendar/_model/constants/view.constants.ts
import type { DayEventPillVariant } from "@/workspace/calendar/_model/types/view.types";
