// app/(workspace)/workspace/[teamId]/_components/views/_components/SettingsView.tsx
'use client';

import clsx from "clsx";
import { useSettingsPreferences } from "../../../_model/hooks";

const SettingsView = () => {
  const { prefs, apps, notificationPresets, togglePref } = useSettingsPreferences();
