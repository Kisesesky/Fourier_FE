// app/(workspace)/workspace/[teamId]/_components/views/team-members/_components/MembersTab.tsx
'use client';
...
import {
  ...
  TEAM_ROLE_LABELS,
} from "@/app/(workspace)/workspace/[teamId]/_model/constants/view.constants";
import { getInitials } from "@/app/(workspace)/workspace/[teamId]/_model/utils/view.utils";
import type { TeamMembersTabContentProps } from "../_model/types/team-members.types";
