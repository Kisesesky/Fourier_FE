// app/(workspace)/workspace/[teamId]/_components/views/team-members/_components/PendingInvitesTab.tsx
'use client';

import { TEAM_ROLE_LABELS } from "@/app/(workspace)/workspace/[teamId]/_model/constants/view.constants";
import type { TeamPendingInvite } from "../_model/types/team-members.types";
