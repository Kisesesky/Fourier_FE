// app/(workspace)/workspace/[teamId]/_model/constants/project.constants.ts
import { Copy, LayoutGrid, List, Pencil, Trash2 } from "lucide-react";
import type { ProjectViewMode } from "@/types/workspace";
import type { ProjectMenuItem } from "@/app/(workspace)/workspace/[teamId]/_model/types/project.types";
